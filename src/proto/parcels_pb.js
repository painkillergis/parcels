...
goog.exportSymbol('proto.Parcels.Parcel.Polygon.LatLon', null, global);
/**
 ...
 * @constructor
 */
proto.Parcels.Parcel.Polygon.LatLon = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.Parcels.Parcel.Polygon.LatLon, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.Parcels.Parcel.Polygon.LatLon.displayName = 'proto.Parcels.Parcel.Polygon.LatLon';
}
 ...
 * @const
 */
proto.Parcels.Parcel.repeatedFields_ = [2,3];
...
proto.Parcels.Parcel.Polygon.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    proto.Parcels.Parcel.Polygon.LatLon.toObject, includeInstance)
  };
...
proto.Parcels.Parcel.Polygon.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    switch (field) {
    case 1:
      var value = new proto.Parcels.Parcel.Polygon.LatLon;
      reader.readMessage(value,proto.Parcels.Parcel.Polygon.LatLon.deserializeBinaryFromReader);
      msg.addPoints(value);
      break;
    default:
      reader.skipField();
...
proto.Parcels.Parcel.Polygon.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f.length > 0) {
    writer.writeRepeatedMessage(
      1,
      f,
      proto.Parcels.Parcel.Polygon.LatLon.serializeBinaryToWriter
    );
  }
};
 ...
 * @return {!Object}
 */
proto.Parcels.Parcel.Polygon.LatLon.prototype.toObject = function(opt_includeInstance) {
  return proto.Parcels.Parcel.Polygon.LatLon.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.Parcels.Parcel.Polygon.LatLon} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.Parcels.Parcel.Polygon.LatLon.toObject = function(includeInstance, msg) {
  var f, obj = {
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.Parcels.Parcel.Polygon.LatLon}
 */
proto.Parcels.Parcel.Polygon.LatLon.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.Parcels.Parcel.Polygon.LatLon;
  return proto.Parcels.Parcel.Polygon.LatLon.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.Parcels.Parcel.Polygon.LatLon} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.Parcels.Parcel.Polygon.LatLon}
 */
proto.Parcels.Parcel.Polygon.LatLon.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.Parcels.Parcel.Polygon.LatLon.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.Parcels.Parcel.Polygon.LatLon.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.Parcels.Parcel.Polygon.LatLon} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.Parcels.Parcel.Polygon.LatLon.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
 ...
 * @return {number}
 */
proto.Parcels.Parcel.Polygon.LatLon.prototype.getLatitude = function() {
...
/**
 * @param {number} value
 * @return {!proto.Parcels.Parcel.Polygon.LatLon} returns this
 */
proto.Parcels.Parcel.Polygon.LatLon.prototype.setLatitude = function(value) {
 ...
 * @return {!proto.Parcels.Parcel.Polygon.LatLon} returns this
 */
proto.Parcels.Parcel.Polygon.LatLon.prototype.clearLatitude = function() {
 ...
 * @return {boolean}
 */
proto.Parcels.Parcel.Polygon.LatLon.prototype.hasLatitude = function() {
 ...
 * @return {number}
 */
proto.Parcels.Parcel.Polygon.LatLon.prototype.getLongitude = function() {
 ...
 * @return {!proto.Parcels.Parcel.Polygon.LatLon} returns this
 */
proto.Parcels.Parcel.Polygon.LatLon.prototype.setLongitude = function(value) {
 ...
 * @return {!proto.Parcels.Parcel.Polygon.LatLon} returns this
 */
proto.Parcels.Parcel.Polygon.LatLon.prototype.clearLongitude = function() {
 ...
 * @return {boolean}
 */
proto.Parcels.Parcel.Polygon.LatLon.prototype.hasLongitude = function() {
 ...
 * @return {!Array<!proto.Parcels.Parcel.Polygon.LatLon>}
 */
proto.Parcels.Parcel.Polygon.prototype.getPointsList = function() {
  return /** @type{!Array<!proto.Parcels.Parcel.Polygon.LatLon>} */ (
    jspb.Message.getRepeatedWrapperField(this, proto.Parcels.Parcel.Polygon.LatLon, 1));
};


/**
 * @param {!Array<!proto.Parcels.Parcel.Polygon.LatLon>} value
...
/**
 * @param {!proto.Parcels.Parcel.Polygon.LatLon=} opt_value
 * @param {number=} opt_index
 * @return {!proto.Parcels.Parcel.Polygon.LatLon}
 */
proto.Parcels.Parcel.Polygon.prototype.addPoints = function(opt_value, opt_index) {
  return jspb.Message.addToRepeatedWrapperField(this, 1, opt_value, proto.Parcels.Parcel.Polygon.LatLon, opt_index);
};
